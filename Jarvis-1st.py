# This is Jarvis-1st.py File with Male Voice.
import datetime
import os
import sys
import subprocess
...
if __name__ == '__main__':
    while True:
        ...
        if 'what can you do' in query:
            ...
            print("    \_---_/                      ")
            print("      | |                        ")
            speak("sorry, but i am not able talk in other languages, but my team is worked hard to achieve it")
            os.system("python Jarvis_Main.py")
        ...
        # System Commands and Jarvis main commands
            ...
            print("Stopped")
            speak("I am Paused, Call out to me to speak to me again")
